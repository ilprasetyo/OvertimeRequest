...
namespace OvertimeRequestMVC.Controllers
{
    public class ApproveManagerController : Controller
    {
        ...
        public HttpStatusCode Approve(ResponseVM approveVM)
        {
            ...
            var result = httpClient.PostAsync("https://localhost:44323/api/Request/ApproveManager", content).Result;
        ...
        public HttpStatusCode Reject(ResponseVM approveVM)
        {
            var httpClient = new HttpClient();
            StringContent content = new StringContent(JsonConvert.SerializeObject(approveVM), Encoding.UTF8, "application/json");
            var result = httpClient.PostAsync("https://localhost:44323/api/Request/RejectManager", content).Result;
            return result.StatusCode;
        }
    }
}
